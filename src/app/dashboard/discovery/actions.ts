...
export async function getTaskPage(filters:TaskFilters){try{return {...await taskPage(filters),error:''};}catch(e){return {items:[],total:0,page:1,people:[],projects:[],error:e instanceof Error?e.message:'Tasks could not load.'};}}
