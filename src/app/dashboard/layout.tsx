          ...
          <div className="flex items-center space-x-8">
            ...
            <nav className="hidden md:flex items-center space-x-1 text-sm font-medium">
              ...
              {isAdmin && (
                <Link
                  href="/admin/users"
                  className="px-3 py-2 rounded-md text-gray-700 hover:bg-gray-100 hover:text-gray-900 transition flex items-center"
                >
                  <Users className="w-4 h-4 mr-1.5 text-gray-500" /> Team Users
                </Link>
              )}
            </nav>
          </div>
