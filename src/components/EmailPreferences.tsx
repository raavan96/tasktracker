export default function EmailPreferences({deliveryEnabled}:{deliveryEnabled:boolean}){
 ...
 <p className="mt-2 text-sm leading-6 text-gray-600">You receive task assignments, mentions, review updates, daily deadline summaries from 9 AM IST, and your weekly task and project report on Mondays from 11 AM IST.</p>
