...
export type Notification={id:string;title:string;message:string;created_at:string;is_read:boolean;task?:{id:string;project_id:string}|null};
export default function NotificationsClient({notifications,filter,unread,page,pages,total}:{notifications:Notification[];filter:string;unread:number;page:number;pages:number;total:number}){
 ...
 return <div className="w-full max-w-4xl mx-auto space-y-6"><div><h1 className="text-2xl font-bold">Notifications</h1><p className="text-sm text-gray-500">Assignments, deadline reminders, and review updates.</p></div>
