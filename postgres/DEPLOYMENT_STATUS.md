...
Eight-session browser tests passed on GitHub with PostgreSQL 16. An eight-user workload has not yet been run against this Droplet's complete staging stack. Production migration, credential migration, backup/restore rehearsal, and cutover remain separate work.
