...
export type Notification={id:string;dedupe_key?:string;title:string;message:string;created_at:string;is_read:boolean;task?:{id:string;project_id:string}|null};
